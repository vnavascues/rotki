...
from typing import Any, DefaultDict, Dict, List, NamedTuple, Set, Tuple, Union
...
class LiquidityPoolEventsBalance(NamedTuple):
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'profit_loss0': self.profit_loss0,
            'profit_loss1': self.profit_loss1,
            'usd_profit_loss': self.usd_profit_loss,
            'lp_profit_loss': self.lp_profit_loss,
        }
