...
def test_get_kusama_address_from_substrate_public_key(public_key, address):
    kusama_address = get_kusama_address_from_substrate_public_key(public_key)
...
def test_get_kusama_address_from_substrate_public_key_invalid(public_key):
    with pytest.raises(ValueError):
        get_kusama_address_from_substrate_public_key(public_key)
